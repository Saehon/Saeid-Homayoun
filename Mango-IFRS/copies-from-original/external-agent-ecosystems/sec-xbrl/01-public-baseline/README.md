# Pilot 001 — Microsoft SEC/XBRL → Versioned Evidence / MLflow → Multi-Agent Falsification

Status: reproducible pilot scaffold. Designed to run locally or in GitHub Actions.
