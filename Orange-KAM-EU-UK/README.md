...
## Scope
EU/UK Key Audit Matters (KAM)

## Evidence hierarchy
Primary authoritative sources first: IAASB/ISA 701; UK/EU regulatory sources; annual reports; verified public Big4 references.

## Research use
KAM dynamics, cross-country comparison, NLP/LLM coding and audit-quality research.
...
## Core folders
- `data/` — reproducible/open or appropriately licensed data references
...
- `research/` — hypotheses, methods and paper outputs
