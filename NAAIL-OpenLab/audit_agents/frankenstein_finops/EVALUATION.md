# FRANKENSTEIN Evaluation Framework — NAAIL OpenLab
...
## NAAIL promotion rule

Results remain research outputs until provenance, evaluation, reproducibility, adversarial review, and the NAAIL Human Approval Gate are satisfied. Implemented code alone is not an empirical result.
