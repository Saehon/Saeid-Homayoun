...
EVIDENCE_BOUNDARY = (
    "This is a NAAIL OpenLab internal-audit research prototype governed by the Two-Core Constitution and Human Approval Gate. Treat deterministic finding IDs as the only "
