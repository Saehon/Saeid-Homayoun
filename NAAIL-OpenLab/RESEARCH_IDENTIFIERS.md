# NAAIL OpenLab™ — Research Identifiers
...
NAAIL OpenLab currently resides as a directory inside `Saehon/Saeid-Homayoun`. The umbrella repository's root `CITATION.cff` describes another research system and therefore should not be used as NAAIL-specific Zenodo metadata.

For a fully independent GitHub→Zenodo lifecycle, a dedicated `Saehon/NAAIL-OpenLab` repository is preferable. Until that migration occurs, use a separate NAAIL Zenodo software deposit or an explicitly NAAIL-scoped archival package.
