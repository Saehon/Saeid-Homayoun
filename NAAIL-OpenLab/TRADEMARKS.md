...
The names and source-identifying designations **NAAIL™**, **NAAIL OpenLab™**, **POMELO™**, **KIWI™**, **VERA™**, **ECONOVA-S™**, **CCCMP™**, **NAAIL Value Expansion Fabric™**, **NAAIL Behavioral Decision Science & Human–AI Experimentation Layer™**, **Evidence Passport™**, **Professional Decision DAG™**, **DAG Watch™**, **Agent Arena™**, **Failure Memory™**, **Decision–Consequence Engine™**, **Professional Judgment Passport™**, and **NAAIL Data & Evidence Mesh™**, together with associated logos, badges, and branding, are reserved by the project owner to the extent protectable under applicable law.
...
Third-party names, trademarks, product names, standards-body names, professional-body names, university names, company names, procurement portals, datasets and open-source project names referenced in NAAIL materials remain the property of their respective owners. Their appearance is descriptive and does not imply affiliation or endorsement.
