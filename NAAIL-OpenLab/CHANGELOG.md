...
- Added current Microsoft/Google/OpenAI public engineering benchmark.
- Added `CITATION.bib`, `codemeta.json`, `AUTHORS.md`, and version marker.
- Updated `CITATION.cff` and README citation to v0.2.1.
- Reworked README into a product/research landing page with public/private IP boundary.
