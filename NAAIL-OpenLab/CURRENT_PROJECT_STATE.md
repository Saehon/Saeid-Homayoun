...
**Newest bounded company POC:** `NAAIL-MSFT-POC-V1 / RESEARCH_PROTOTYPE`

> **PATENT RIGHTS RESERVED — PATENT APPLICATION PREPARATION IN PROGRESS**

## Constitutional rule

The **[NAAIL Two-Core Constitution](./TWO_CORE_CONSTITUTION.md)** is the governing architecture rule. No new company, domain, dataset, AI model, vendor, agent or prototype may create a third permanent core.

## Microsoft Golden Anchor POC V1

[Open Microsoft POC V1](./prototypes/microsoft-poc-v1/MICROSOFT_POC_V1.md)

Microsoft Corporation is the first integrated Golden Anchor Company used to test whether NAAIL can connect real public company evidence, reproducible analysis, multiple domain modules, a company Digital Twin, AI-cost measurement, behavioral experiment design, Evidence Passport™ and Human Gate™ in one bounded package.

### Current synchronized public package
...
- Microsoft FY2026 SEC/interactive-XBRL public facts, including income statement, balance sheet, cash-flow and segment evidence;
...
## Microsoft POC public assets

- [`MICROSOFT_POC_V1.md`](./prototypes/microsoft-poc-v1/MICROSOFT_POC_V1.md)
...
- `microsoft_text_features.csv`
- `microsoft_financial_features.csv`
- `microsoft_innovation_features.csv`
- `ai_cost_benchmark.csv`
- `human_ai_experiment_design.md`
- reproducible Python code, tests and `dashboard.html`.
...
This state record is non-enabling. Detailed unpublished core algorithms, graph/provenance contracts, dependency/revocation logic and patent-sensitive embodiments remain private. The Microsoft POC publishes bounded reproducible arithmetic and public facts without disclosing confidential patent claim material.

No patent application is represented as filed as of 2026-09-16; **Patent Pending** is not claimed.
